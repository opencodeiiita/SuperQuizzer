...
object SportsQuestion{
    fun getQuestions():ArrayList<Question>{
        val questionsArray = ArrayList<Question>()

        val question1 = Question(1,"“Electra Gold Cup” is associated with which sports?",
            "Lawn Tennis","Badminton","Table Tennis","Cricket",3)
        ...
        val question10 = Question(10,"Kazakhstan is a part of which of the following continental confederations recognized by FIFA?",
            "Asian Football Confederation","Union of European Football Associations","Confederation Africaine de Football","Fifa",2)
